...
@section('content')
    <div class="card">
        <form action="/users/edit/{{ $user->id }}" method="post" class="form" id="form">
            <div class="card-body">
            ...
            <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input id="name" type="text" name="name" value="{{ $user->name }}" placeholder="Digite..." class="form-control" required>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <b><label for="email">E-mail</label></b>
                                <input id="email" type="email" name="email" value="{{ $user->email }}" placeholder="Digite..." class="form-control" required>
                            </div>
                        </div>
                        <div class="col-md-6" style="margin-top:15px">
                            <b><label for="data_nascimento">Data de Nascimento</label></b>
                            <input id="birth_date" type="date" name="birth_date" value="{{ $user->birth_date }}" placeholder="Digite..." class="form-control" readonly="readyonly">
                        </div>
                        <div class="col-md-6" style="margin-top:15px">
